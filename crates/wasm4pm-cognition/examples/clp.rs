...
fn main() {
    let input = BreedInput {
        ...
        facts: vec![
            ...
            Fact {
                key: "clp:var:A".to_string(),
                value: "1..4".to_string(),
            },
            Fact {
                key: "clp:var:B".to_string(),
                value: "1..4".to_string(),
            },
            Fact {
                key: "clp:var:C".to_string(),
                value: "1..4".to_string(),
            },
            Fact {
                key: "clp:var:D".to_string(),
                value: "1..4".to_string(),
            },
            // Constraints (sorted key order controls posting sequence).
            // c1: A must precede B
            Fact {
                key: "clp:constraint:c1".to_string(),
                value: "A<B".to_string(),
            },
            // c2: C must precede D
            Fact {
                key: "clp:constraint:c2".to_string(),
                value: "C<D".to_string(),
            },
            // c3: A and C cannot share the same slot
            Fact {
                key: "clp:constraint:c3".to_string(),
                value: "A!=C".to_string(),
            },
            // c4: all tasks occupy distinct slots
            Fact {
                key: "clp:constraint:c4".to_string(),
                value: "alldiff(A,B,C,D)".to_string(),
            },
        ],
        cases: vec![],
        rules: vec![],
