...
export declare function spawnWorker(workerId: string, xesContent: string, label?: string): WorkerState;
...
export declare function getResult(workerId: string, algorithmId?: string): WorkerResult | WorkerResult[] | undefined;
