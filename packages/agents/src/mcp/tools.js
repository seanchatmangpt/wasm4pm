...
export const agentToolDefinitions = [
    {
        name: 'agent_execute',
        description: 'Execute a Van der Aalst process mining agent to detect violations and optionally apply autonomous corrections',
        inputSchema: {
            type: 'object',
            properties: {
                agent: {
    ...
    },
    {
        ...
        description: 'Run a full MAPE-K autonomic cycle (Monitor → Analyze → Plan → Execute → Learn) for an artifact',
        inputSchema: {
            type: 'object',
            properties: {
                artifact_id: {
    ...
    },
    {
        ...
        description: 'Validate evidence alignment across 4 surfaces (execution, telemetry, state, process)',
        inputSchema: {
            type: 'object',
            properties: {
                artifact_id: {
