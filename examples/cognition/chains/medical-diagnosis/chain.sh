#!/usr/bin/env bash
# chain.sh — medical-diagnosis breed chain orchestrator
set -euo pipefail
...
# ---------------------------------------------------------------------------
STAGES=(
  "0:0-bayesian_network:bayesian_network"
  "1:1-dempster_shafer:dempster_shafer"
  "2:2-abductive_lp:abductive_lp"
  "3:3-default_logic:default_logic"
  "4:4-description_logic:description_logic"
  "5:5-partial_order_plan:partial_order_plan"
)
...
for entry in "${STAGES[@]}"; do
  ...
  # Extract output_hash for display
