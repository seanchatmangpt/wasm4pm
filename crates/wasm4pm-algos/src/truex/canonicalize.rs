    ...
    match value {
        ...
        Value::Array(arr) => {
            ...
            if let Some(first) = clone.first().and_then(|v| v.as_object()) {
                ...
                } else if first.contains_key("ocel:event-id")
                    && first.contains_key("ocel:object-id")
                {
                    clone.sort_by(|a, b| {
                        let key_a = format!(
                            "{}|{}|{}",
                            a.get("ocel:event-id")
                                .and_then(|v| v.as_str())
                                .unwrap_or(""),
                            a.get("ocel:object-id")
                                .and_then(|v| v.as_str())
                                .unwrap_or(""),
                            a.get("ocel:qualifier")
                                .and_then(|v| v.as_str())
                                .unwrap_or("")
                        );
                        let key_b = format!(
                            ...
                            b.get("ocel:event-id")
                                .and_then(|v| v.as_str())
                                .unwrap_or(""),
                            b.get("ocel:object-id")
                                .and_then(|v| v.as_str())
                                .unwrap_or(""),
                            b.get("ocel:qualifier")
                                .and_then(|v| v.as_str())
                                .unwrap_or("")
                        );
                        key_a.cmp(&key_b)
                    ...
                    clone.sort_by(|a, b| {
                        let time_a = a
                            .get("ocel:timestamp")
                            .or_else(|| a.get("ocel:time"))
                            .and_then(|v| v.as_str())
                            .unwrap_or("");
                        let time_b = b
                            .get("ocel:timestamp")
                            .or_else(|| b.get("ocel:time"))
                            .and_then(|v| v.as_str())
                            .unwrap_or("");
                        let key_a = format!(
                            "{}|{}|{}",
