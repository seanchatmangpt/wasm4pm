...
#[wasm_bindgen]
pub fn discover_alpha_ppp_wasm(log_handle: &str, activity_key: &str, absolute_df_clean_thresh: usize, causal_threshold: f64) -> Result<JsValue, JsValue> {
    ...
    get_or_init_state().with_object(log_handle, |obj| match obj {
        ...
        _ => Err(crate::error::wasm_err(crate::error::codes::INVALID_INPUT, "Object is not an EventLog")),
    })
}
...
pub fn discover_ocdfg_wasm(ocel_handle: &str) -> Result<JsValue, JsValue> {
    get_or_init_state().with_object(ocel_handle, |obj| match obj {
        ...
        _ => Err(crate::error::wasm_err(crate::error::codes::INVALID_INPUT, "Object is not an OCEL")),
    })
}
...
#[wasm_bindgen]
pub fn discover_oc_declare_wasm(ocel_handle: &str, noise_threshold: f64) -> Result<JsValue, JsValue> {
