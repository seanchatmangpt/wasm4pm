#!/usr/bin/env python3
"""
generate_capability_matrix.py — generates capability-matrix.json for wasm4pm v26.5.21
...
Usage:
  python3 scripts/generate_capability_matrix.py \
    ...
    --output target/wasm4pm-v26.5.21/capability-matrix.json \
    --version 26.5.21
...
def parse_args():
    ...
    p.add_argument("--output", default="target/wasm4pm-v26.5.21/capability-matrix.json")
