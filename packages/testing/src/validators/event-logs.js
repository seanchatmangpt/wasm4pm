 ...
 */
export function validateXES(xesContent) {
    const errors = [];
    const warnings = [];
    // Parse XML
    let doc;
 ...
 */
export function validateXESStructure(xes) {
    const errors = [];
    const warnings = [];
 ...
 */
export function validateCSV(csvContent, options = {}) {
    const errors = [];
    const warnings = [];
 ...
 */
export function validateTimestampOrdering(log) {
    const errors = [];
    const warnings = [];
    log.traces?.forEach((trace, traceIndex) => {
        const tracePath = `traces[${traceIndex}]`;
 ...
 */
export function validateTraceCompleteness(log, expectedActivities) {
    const errors = [];
    const warnings = [];
 ...
 */
export function validateNoDuplicates(log) {
    const errors = [];
    const warnings = [];
    log.traces?.forEach((trace, traceIndex) => {
        const tracePath = `traces[${traceIndex}]`;
...
//# sourceMappingURL=event-logs.js.map