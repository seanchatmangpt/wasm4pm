...
fn pointer_fixture_autoinstinct_learning_14_is_real() {
    // True pointer: "4 steps to goal" — Sussman 1973 (MIT AI TR-297), Chapter II Scenario Sections 1-5, Problems 3.1-3.5
    assert_real_fixture("autoinstinct_learning");
}

#[test]
fn pointer_fixture_autoinstinct_neurosis_16_is_real() {
    // True pointer: "conflict_pairs=6" — Colby, K. M., Weber, S., & Hilf, F. D. (1971). Artificial Paranoia. Artificial Intelligence, 2(1), 1-25 (PARRY's paranoid belief-conflict processing -- the real primary source autoinstinct_neurosis.rs's own module doc names as its lineage; Boden 1977 Ch.6 is a secondary survey of this same work, not the primary source)
...
#[test]
fn pointer_fixture_autoinstinct_vision_19_is_real() {
    // True pointer: "B" — Winograd 1972, Understanding Natural Language, Chapter 2 -- the real primary source autoinstinct_vision.rs's own module doc names (symbolic blocks-world scene parsing, find_clear_object()); Marr & Poggio 1976 stereo-disparity convergence describes an algorithm that does not exist anywhere in this breed's real implementation and was a wrong prior citation
    assert_real_fixture("autoinstinct_vision");
}

#[test]
fn pointer_fixture_bayesian_network_21_is_real() {
...
#[test]
fn pointer_fixture_belief_merging_23_is_real() {
...
#[test]
fn pointer_fixture_cbr_25_is_real() {
...
#[test]
fn pointer_fixture_circumscription_27_is_real() {
...
#[test]
fn pointer_fixture_contingent_plan_34_is_real() {
...
#[test]
fn pointer_fixture_csp_ac3_36_is_real() {
...
#[test]
fn pointer_fixture_ctl_check_38_is_real() {
...
#[test]
fn pointer_fixture_default_logic_40_is_real() {
...
#[test]
fn pointer_fixture_dempster_shafer_42_is_real() {
...
#[test]
fn pointer_fixture_dendral_44_is_real() {
...
#[test]
fn pointer_fixture_description_logic_46_is_real() {
...
#[test]
fn pointer_fixture_ebl_48_is_real() {
...
#[test]
fn pointer_fixture_eliza_50_is_real() {
...
#[test]
fn pointer_fixture_episodic_memory_52_is_real() {
...
#[test]
fn pointer_fixture_event_calculus_54_is_real() {
...
#[test]
fn pointer_fixture_frames_inheritance_56_is_real() {
...
#[test]
fn pointer_fixture_fuzzy_logic_58_is_real() {
...
#[test]
fn pointer_fixture_gps_60_is_real() {
...
#[test]
fn pointer_fixture_hearsay_62_is_real() {
...
#[test]
fn pointer_fixture_htn_planning_64_is_real() {
...
#[test]
fn pointer_fixture_ilp_66_is_real() {
...
#[test]
fn pointer_fixture_ltl_monitor_68_is_real() {
...
#[test]
fn pointer_fixture_markov_logic_70_is_real() {
...
#[test]
fn pointer_fixture_mdp_72_is_real() {
...
#[test]
fn pointer_fixture_meta_reasoning_74_is_real() {
...
#[test]
fn pointer_fixture_morphological_76_is_real() {
...
#[test]
fn pointer_fixture_mycin_78_is_real() {
...
#[test]
fn pointer_fixture_naive_physics_80_is_real() {
...
#[test]
fn pointer_fixture_ocpm_route_discoverer_82_is_real() {
...
#[test]
fn pointer_fixture_partial_order_plan_84_is_real() {
...
#[test]
fn pointer_fixture_pomdp_86_is_real() {
...
#[test]
fn pointer_fixture_problog_88_is_real() {
...
#[test]
fn pointer_fixture_prolog_90_is_real() {
...
#[test]
fn pointer_fixture_qualitative_reason_92_is_real() {
...
#[test]
fn pointer_fixture_rl_symbolic_94_is_real() {
...
#[test]
fn pointer_fixture_sat_cdcl_96_is_real() {
...
#[test]
fn pointer_fixture_script_sam_98_is_real() {
...
#[test]
fn pointer_fixture_situation_calculus_100_is_real() {
...
#[test]
fn pointer_fixture_soar_102_is_real() {
...
#[test]
fn pointer_fixture_strips_104_is_real() {
...
#[test]
fn pointer_fixture_tableaux_106_is_real() {
...
#[test]
fn pointer_fixture_triz_108_is_real() {
...
#[test]
fn pointer_fixture_version_space_110_is_real() {
