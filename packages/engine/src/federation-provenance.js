 ...
 * ```
 */
export function computeProvenanceChain(eventLogIR, config, plan, modelHash, algorithmId, algorithmVersion, backendId, kernelVersion, wasmBuildHash) {
 ...
 * ```
 */
export function buildModelIR(rawOutput, algorithmId, capabilities) {
    const model = rawOutput.model;
 ...
 */
function inferModelType(algorithmId) {
 ...
 * ```
 */
export function wrapDiscoveryResult(rawOutput, eventLogIR, config, plan, algorithmId, backendId, kernelVersion, wasmBuildHash, cycleSeq, modelCapabilities) {
    ...
    const provenance = computeProvenanceChain(eventLogIR, config, plan, rawOutput.model_hash, algorithmId, rawOutput.algorithm_version, backendId, kernelVersion, wasmBuildHash);
...
//# sourceMappingURL=federation-provenance.js.map