#!/usr/bin/env bash
# chain.sh — system-verification breed chain orchestrator
# Runs 5 cognition stages: asp -> abductive_ibe -> ilp -> ctl_check -> markov_logic
set -euo pipefail
...
STAGES=(
  "0:0-asp:asp"
  "1:1-abductive_ibe:abductive_ibe"
  "2:2-ilp:ilp"
  "3:3-ctl_check:ctl_check"
  "4:4-markov_logic:markov_logic"
)
