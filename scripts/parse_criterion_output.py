#!/usr/bin/env python3
"""
parse_criterion_output.py — parses Criterion benchmark output for wasm4pm v26.5.19
...
Usage:
  python3 scripts/parse_criterion_output.py \
    ...
    --output target/wasm4pm-v26.5.19/criterion-results.json
...
def parse_args():
    ...
    p.add_argument("--output", default="target/wasm4pm-v26.5.19/criterion-results.json")
    return p.parse_args()
