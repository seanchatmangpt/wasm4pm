...
## Initial Request — 2026-06-10T15:37:51-07:00

Objective: You are the Tier P1 Orchestrator. Implement and verify the 10 Tier P1 cognition breeds:
1. `ltl_monitor`
2. `allen_temporal`
3. `fuzzy_logic`
4. `bayesian_network`
...
Your working directory is: `/Users/sac/wasm4pm/.agents/orchestrator_p1/`
...
5. Add the breed's lifecycle model const in `crates/wasm4pm-cognition/src/ocel/models_p1.rs` (create this file if it doesn't exist, register in `crates/wasm4pm-cognition/src/ocel/mod.rs` `lifecycle_model_for`).
