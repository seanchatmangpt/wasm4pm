...
export const executionProfileSchema = z
    .enum(['fast', 'balanced', 'quality', 'stream'])
...
const ML_TASKS = ['classify', 'cluster', 'forecast', 'anomaly', 'regress', 'pca'];
export const mlConfigSchema = z
    ...
    .describe('ML analysis configuration — classification, clustering, forecasting, anomaly, regression, PCA');
/**
...
export const rlConfigSchema = z
    ...
    .describe('RL / GPU execution configuration — LinUCB contextual bandit for algorithm selection');
// --- Root Schema ---
 ...
 */
export function validatePartial(config) {
    try {
