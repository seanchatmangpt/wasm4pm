...
export const BALANCED_ALPHA_CONFIG = {
    version: '1.0',
    source: { kind: 'file', path: '/data/events.xes', format: 'xes' },
...
export const QUALITY_GENETIC_CONFIG = {
    version: '1.0',
...
export const STREAM_WATCH_CONFIG = {
    version: '1.0',
...
export const PIPELINE_DAG_CONFIG = {
    version: '1.0',
...
export const INLINE_CONTENT_CONFIG = {
    version: '1.0',
    source: {
        kind: 'inline',
        format: 'xes',
...
export const BARE_MINIMUM_CONFIG = {
    version: '1.0',
    source: { kind: 'file' },
    execution: { profile: 'fast' },
};
/** Edge case: maxed-out timeouts and memory */
export const MAX_RESOURCES_CONFIG = {
    version: '1.0',
...
export const ML_CLASSIFY_CONFIG = {
    version: '1.0',
    source: { kind: 'file', path: '/data/events.xes', format: 'xes' },
...
export const ML_ALL_TASKS_CONFIG = {
    version: '1.0',
    source: { kind: 'file', path: '/data/events.xes', format: 'xes' },
...
export const ALL_VALID_CONFIGS = [
    MINIMAL_CONFIG,
