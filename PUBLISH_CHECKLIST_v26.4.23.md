...
- [x] All 10 `@pictl/*` packages: 26.4.23
...
npm view @seanchatmangpt/pictl@26.4.23
npm view wasm4pm@26.4.23
npm view @pictl/contracts@26.4.23
```
...
# Check package sizes
npm view @seanchatmangpt/pictl@26.4.23 dist.unpackedSize
...
npm init -y
npm install @seanchatmangpt/pictl@26.4.23 wasm4pm@26.4.23
...
npm deprecate @seanchatmangpt/pictl@26.4.23 "Deprecated: See v26.4.17"
...
npm unpublish @seanchatmangpt/pictl@26.4.23 --force
```
...
- [ ] `npm view @seanchatmangpt/pictl@26.4.23` returns version 26.4.23
- [ ] `npm view wasm4pm@26.4.23` returns version 26.4.23
- [ ] All 10 `@pictl/*` packages appear on npm
- [ ] `npm install @seanchatmangpt/pictl@26.4.23` succeeds (global install)
- [ ] `pictl --version` outputs `26.4.23`
