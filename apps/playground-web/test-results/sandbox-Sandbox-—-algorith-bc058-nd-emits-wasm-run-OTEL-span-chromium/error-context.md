...
- Name: sandbox.spec.ts >> Sandbox — algorithm runner >> run DFG algorithm on small-example preset and emits wasm.run OTEL span
- Location: tests/e2e/sandbox.spec.ts:24:3
