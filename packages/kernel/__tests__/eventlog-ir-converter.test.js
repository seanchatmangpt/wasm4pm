...
import { eventLogIrToWasmJson, wasmJsonToEventLogIr, isValidIso8601, validateLogTimestamps, hashEventLogIr, } from '../src/converters/eventlog-ir-converter.js';
describe('eventlog-ir-converter', () => {
    ...
    describe('round-trip losslessness', () => {
        it('EventLogIR → JSON → EventLogIR preserves data', () => {
            ...
            expect(reconstructed.traces[0].events[0].activity).toBe(simpleLog.traces[0].events[0].activity);
        });
...
//# sourceMappingURL=eventlog-ir-converter.test.js.map