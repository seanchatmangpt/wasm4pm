...
fn main() {
    let input = BreedInput {
        ...
        facts: vec![
            ...
            Fact {
                key: "pop:op:put_c_from_a_on_table:pre".to_string(),
                value: "clear_c,on_c_a".to_string(),
            },
            Fact {
                key: "pop:op:put_c_from_a_on_table:add".to_string(),
                value: "clear_a,ontable_c".to_string(),
            },
            Fact {
                key: "pop:op:put_c_from_a_on_table:del".to_string(),
                value: "on_c_a".to_string(),
            },
            // Operator: stack A on B
            Fact {
                key: "pop:op:put_a_on_b:pre".to_string(),
                value: "clear_a,clear_b,ontable_a".to_string(),
            },
            Fact {
                key: "pop:op:put_a_on_b:add".to_string(),
                value: "on_a_b".to_string(),
            },
            Fact {
                key: "pop:op:put_a_on_b:del".to_string(),
                value: "clear_b,ontable_a".to_string(),
            },
            // Operator: stack B on C
            Fact {
                key: "pop:op:put_b_on_c:pre".to_string(),
                value: "clear_b,clear_c,ontable_b".to_string(),
            },
            Fact {
                key: "pop:op:put_b_on_c:add".to_string(),
                value: "on_b_c".to_string(),
            },
            Fact {
                key: "pop:op:put_b_on_c:del".to_string(),
                value: "clear_c,ontable_b".to_string(),
            },
        ],
        cases: vec![],
        rules: vec![],
        ...
        goals: vec![
            Goal {
                id: "g0".to_string(),
                predicate: "on_a_b".to_string(),
                value: "true".to_string(),
            },
            Goal {
                id: "g1".to_string(),
                predicate: "on_b_c".to_string(),
                value: "true".to_string(),
            },
        ],
        ...
        state: vec![
            StateAtom {
                predicate: "on_c_a".to_string(),
                value: "true".to_string(),
            },
            StateAtom {
                predicate: "clear_c".to_string(),
                value: "true".to_string(),
            },
            StateAtom {
                predicate: "clear_b".to_string(),
                value: "true".to_string(),
            },
            StateAtom {
                predicate: "ontable_a".to_string(),
                value: "true".to_string(),
            },
            StateAtom {
                predicate: "ontable_b".to_string(),
                value: "true".to_string(),
            },
        ],
    };
