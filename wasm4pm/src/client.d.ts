...
import { EventLogHandleId, OCELHandleId, DFGHandleId, PetriNetHandleId, DeclareHandleId, TemporalProfileHandleId, NGramPredictorHandleId, StreamingDFGHandleId, StreamingConformanceHandleId, OCPetriNetHandleId } from './types.js';
/**
...
export declare class ProcessMiningClient {
     ...
     */
    discoverTemporalProfile(log: EventLogHandle, options?: {
        activityKey?: string;
        timestampKey?: string;
     ...
     */
    buildNGramPredictor(log: EventLogHandle, options?: {
        activityKey?: string;
        n?: number;
     ...
     */
    buildRemainingTimeModel(log: EventLogHandle, options?: {
        activityKey?: string;
        timestampKey?: string;
...
export declare class EventLogHandle {
     ...
     */
    extractCaseFeatures(activityKey?: string, timestampKey?: string, config?: api.FeatureExtractionConfig): Promise<api.FeatureVector[]>;
    /**
     * Extract prefix-level features for remaining time/outcome prediction
     */
    extractPrefixFeatures(activityKey?: string, timestampKey?: string, prefixLength?: number): Promise<api.FeatureVector[]>;
    /**
     * Export extracted features as CSV
     */
    exportFeaturesAsCSV(activityKey?: string, timestampKey?: string, config?: api.FeatureExtractionConfig): Promise<string>;
    /**
     ...
     */
    analyzeResourceUtilization(resourceKey?: string, timestampKey?: string): Promise<api.ResourceUtilization[]>;
    /**
     * Analyze resource-activity interactions
     */
    analyzeResourceActivityMatrix(resourceKey?: string, activityKey?: string): Promise<api.ResourceActivityMatrix>;
    /**
     * Identify resource bottlenecks
     */
    identifyResourceBottlenecks(resourceKey?: string, timestampKey?: string, activityKey?: string): Promise<api.ResourceBottleneck[]>;
    /**
...
export declare class TemporalProfileHandle {
     ...
     */
    checkConformance(log: EventLogHandle, options?: {
        activityKey?: string;
        timestampKey?: string;
        zeta?: number;
    }): any;
 ...
 */
export declare function encodeVariantsAsText(logHandle: EventLogHandle, activityKey?: string, topN?: number): Promise<string>;
/**
 ...
 */
export declare function encodeModelComparisonAsText(model1Handle: DFGHandle | PetriNetHandle, model2Handle: DFGHandle | PetriNetHandle): Promise<string>;
/**
 ...
 */
export declare function computeBoundaryCoverage(logHandle: EventLogHandle, prefix: string[], activityKey?: string): any;
/**
 ...
 */
export declare function detectDrift(logHandle: EventLogHandle, activityKey?: string, windowSize?: number): any;
/**
 ...
 * @param activityKey - attribute key for the activity name
 */
export declare function buildTransitionProbabilities(logHandle: EventLogHandle, activityKey?: string): any;
/**
 ...
 */
export declare function rankInterventions(interventions: Array<{
    name: string;
    utility: number;
}>, exploitationWeight?: number): any;
/**
 ...
 */
export declare function selectIntervention(banditState: {
    arms: Array<{
        name: string;
        total_reward: number;
        pull_count: number;
