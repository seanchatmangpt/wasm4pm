...
import { checkDeterminism, stableReceiptHash, receiptsMatch, } from '../../src/harness/determinism.js';
describe('Determinism Harness', () => {
    ...
    describe('checkDeterminism', () => {
        ...
        it('fails for non-deterministic producer', async () => {
            let counter = 0;
            const result = await checkDeterminism(() => Promise.resolve(makeReceipt({ event_count: ++counter })), 3);
