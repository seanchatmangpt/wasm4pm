...
- [ ] The serialized-name constraint is satisfied: event properties use aliases (`activity`/`timestamp`/`id`/`relationships`) to match  test expectations without breaking OCEL 2.0 standards.
