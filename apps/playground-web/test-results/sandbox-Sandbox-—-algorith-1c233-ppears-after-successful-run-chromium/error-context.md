...
- Name: sandbox.spec.ts >> Sandbox — algorithm runner >> receipt tab appears after successful run
- Location: tests/e2e/sandbox.spec.ts:39:3
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Run ⌘/i })
    - waiting for" http://localhost:3000/play?algo=dfg" navigation to finish...
    - navigated to "http://localhost:3000/play?algo=dfg"
