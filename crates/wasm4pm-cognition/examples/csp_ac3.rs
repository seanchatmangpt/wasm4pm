...
fn main() {
    let input = BreedInput {
        ...
        facts: vec![
            ...
            Fact { key: "csp-var".to_string(), value: "A:red,green,blue".to_string() },
            Fact { key: "csp-var".to_string(), value: "B:red,green,blue".to_string() },
            Fact { key: "csp-var".to_string(), value: "C:red,green,blue".to_string() },
            Fact { key: "csp-var".to_string(), value: "D:red,green,blue".to_string() },
            // Constraints: adjacent regions must differ
            Fact { key: "csp-constraint".to_string(), value: "A!=B".to_string() },
            Fact { key: "csp-constraint".to_string(), value: "A!=C".to_string() },
            Fact { key: "csp-constraint".to_string(), value: "B!=C".to_string() },
            Fact { key: "csp-constraint".to_string(), value: "B!=D".to_string() },
            Fact { key: "csp-constraint".to_string(), value: "C!=D".to_string() },
        ],
        cases: vec![],
        rules: vec![],
        goals: vec![],
    ...
    match run_breed(&breed, &input) {
        Ok(output) => {
            ...
            println!("csp_ac3 ok — selected={:?}  hash={}", output.selected, &output_hash[..16]);
