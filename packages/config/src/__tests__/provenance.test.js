...
describe('Provenance', () => {
    describe('trackProvenance', () => {
        ...
        it('tracks nested keys with dot notation', () => {
            const map = trackProvenance({ execution: { profile: 'fast', timeout: 60000 } }, 'toml', './pictl.toml');
        ...
        it('tracks deeply nested keys', () => {
            const map = trackProvenance({ observability: { otel: { enabled: true, endpoint: 'http://localhost:4318' } } }, 'json', './config.json');
        ...
        it('skips undefined and null values', () => {
            const map = trackProvenance({ a: undefined, b: null, c: 'ok' }, 'env');
        ...
        it('records each of the five source types', () => {
            const sources = ['cli', 'toml', 'json', 'env', 'default'];
    ...
    describe('mergeProvenance', () => {
        it('merges non-overlapping maps', () => {
            const a = { 'x': { value: 1, source: 'default' } };
            const b = { 'y': { value: 2, source: 'env' } };
        ...
        it('handles empty maps', () => {
            const a = { k: { value: 1, source: 'default' } };
