...
export type CorrectionType = 'config_restoration' | 'evidence_repair' | 'code_refactoring' | 'process_correction' | 'authority_restoration' | 'stub_elimination' | 'receipt_chain_repair';
...
export declare const VAN_DERAALST_AGENTS: readonly ["mock-interceptor", "config-drift-guardian", "receipt-chain-attacker", "gate-independence-verifier", "evidence-fabrication-detector", "process-mining-skeptic", "theater-detector", "authority-escalation-watcher"];
