// AUTO-RENDERED BY GGEN — edit ggen/ontology/breeds.ttl, then run `ggen sync`.
// Source of truth: wasm4pm-breeds-ts pack (compat:CognitionBreed instances).
...
export const BREED_CATALOG: readonly BreedInfo[] = [
  {
    id: "abductive_ibe",
    label: "AbductiveIbe",
    doc: `Abduction as Inference to the Best Explanation (Harman, 'The Inference to the Best Explanation', Philosophical Review 74(1), 1965; Thagard, 'The Best Explanation: Criteria for Theory Choice', Journal of Philosophy 75(2), 1978).`,
  ...
  },
  {
    id: "abductive_lp",
    label: "AbductiveLp",
    doc: `Abductive Logic Programming (Kakas, Kowalski & Toni, 'Abductive Logic Programming', Journal of Logic and Computation 2(6), 1992).`,
    citation: `Kakas, A. C., Kowalski, R. A., & Toni, F. (1992). Abductive Logic Programming. Journal of Logic and Computation, 2(6), 719–770.`,
  },
  {
    id: "act_r",
    label: "ActR",
    doc: `ACT-R production cycle with declarative retrieval by activation (Anderson & Lebiere 1998, *The Atomic Components of Thought*).`,
  ...
  },
  {
    id: "allen_temporal",
    label: "AllenTemporal",
    doc: `Allen interval algebra — Allen 1983 (CACM 26(11)).`,
    citation: `Allen, J. F. (1983). Maintaining Knowledge about Temporal Intervals. Communications of the ACM, 26(11), 832-843.`,
  },
  {
    id: "analogy_sme",
    label: "AnalogySme",
    doc: `Structure-Mapping Engine (Falkenhainer, Forbus & Gentner 1989).`,
    citation: `Falkenhainer, B., Forbus, K. D., & Gentner, D. (1989). Artificial Intelligence, 41(1), 1-63.`,
  },
  {
    id: "asp",
    label: "Asp",
    doc: `ASP: Answer Set Programming via Gelfond–Lifschitz stable-model semantics (Gelfond & Lifschitz, 'The Stable Model Semantics for Logic Programming', ICLP/SLP 1988).`,
  ...
  },
  {
    ...
    doc: `AutoInstinct Semantics breed — NLU via Schank Conceptual Dependency primitives.`,
  ...
  },
  {
    ...
    doc: `AutoinstinctVision — Symbolic Blocks World perception breed.`,
  ...
  },
  {
    ...
    doc: `Bayesian network inference — Pearl 1988.`,
    citation: `Pearl, J. (1988). Probabilistic Reasoning in Intelligent Systems: Networks of Plausible Inference. Morgan Kaufmann.`,
  },
  {
    id: "belief_merging",
    label: "BeliefMerging",
    doc: `Belief merging: distance-based IC merging operators Σ and GMax (Konieczny & Pino Pérez, 'Merging Information Under Constraints: A Logical Framework', Journal of Logic and Computation 12(5), 2002).`,
  ...
  },
  {
    id: "cbr",
    label: "Cbr",
    doc: `Case-Based Reasoning via Jaccard similarity with Discrimination Net Indexing (Schank 1983).`,
  ...
  },
  {
    ...
    doc: `Predicate circumscription via minimal-model enumeration (McCarthy 1980).`,
    citation: `McCarthy, J. (1980). Artificial Intelligence, 13(1-2), 27-39.`,
  },
  {
    id: "clp",
    label: "Clp",
    doc: `CLP(FD): Constraint Logic Programming over finite integer domains (Jaffar & Lassez, 'Constraint Logic Programming', POPL 1987).`,
  ...
  },
  {
    ...
    doc: `Goldberg Construction Grammar: argument-structure constructions carry meaning independently of the verb's lexical entry (Goldberg 1995, 'Constructions: A Construction Grammar Approach to Argument Structure').`,
  ...
  },
  {
    ...
    doc: `Contingent planning: AND-OR search over belief states with sensing actions (Russell & Norvig, AIMA 3rd ed.`,
    citation: `Stuart Russell and Peter Norvig (2010). Artificial Intelligence: A Modern Approach (3rd ed.). Pearson.`,
  },
  {
    id: "csp_ac3",
    label: "CspAc3",
    doc: `Constraint satisfaction via AC-3 + MAC backtracking — Mackworth 1977.`,
    citation: `Mackworth, A. K. (1977). Consistency in Networks of Relations. Artificial Intelligence, 8(1), 99-118.`,
  },
  {
    id: "ctl_check",
    label: "CtlCheck",
    doc: `CTL model checking by fixed-point labeling (Clarke, Emerson & Sistla 1986, 'Automatic verification of finite-state concurrent systems using temporal logic specifications', ACM TOPLAS 8(2)).`,
    citation: `Clarke, E. M., Emerson, E. A., & Sistla, A. P. (1986). ACM Transactions on Programming Languages and Systems, 8(2), 244-263.`,
  },
  {
    id: "default_logic",
    label: "DefaultLogic",
    doc: `Default logic — Reiter 1980 (normal defaults with justifications).`,
    citation: `Reiter, R. (1980). A Logic for Default Reasoning. Artificial Intelligence, 13(1-2), 81-132.`,
  },
  {
    id: "dempster_shafer",
    label: "DempsterShafer",
    doc: `Dempster–Shafer theory of evidence — Shafer 1976.`,
    citation: `Shafer, G. (1976). A Mathematical Theory of Evidence. Princeton University Press.`,
  },
  {
    id: "dendral",
    label: "Dendral",
    doc: `DENDRAL-style constraint enumeration (Feigenbaum 1971).`,
  ...
  },
  {
    ...
    doc: `Description Logic: EL completion-rule classification (Baader, Brandt & Lutz, 'Pushing the EL Envelope', IJCAI 2005).`,
  ...
  },
  {
    id: "ebl",
    label: "Ebl",
    doc: `Explanation-based learning — Mitchell, Keller & Kedar-Cabelli 1986 (EBG).`,
  ...
  },
  {
    id: "eliza",
    label: "Eliza",
    doc: `ELIZA-style frame/pattern matching with pronoun reflection (Weizenbaum 1966).`,
  ...
  },
  {
    ...
    doc: `Episodic memory: cue-based recall with a temporal-proximity kernel (Tulving 1983, *Elements of Episodic Memory*; Nuxoll & Laird 2007, AAAI — episodic memory in Soar).`,
  ...
  },
  {
    id: "event_calculus",
    label: "EventCalculus",
    doc: `Event Calculus (Kowalski & Sergot, 'A Logic-based Calculus of Events', New Generation Computing 4(1), 1986) — discrete simplified event calculus.`,
  ...
  },
  {
    ...
    doc: `Frame-based inheritance — Minsky 1974.`,
  ...
  },
  {
    id: "fuzzy_logic",
    label: "FuzzyLogic",
    doc: `Mamdani fuzzy inference — Mamdani & Assilian 1975 (Zadeh 1965 sets).`,
  ...
  },
  {
    id: "hearsay",
    label: "Hearsay",
    doc: `Hearsay-II blackboard architecture with knowledge-source consensus fusion via noisy-OR (Erman & Lesser 1980).`,
  ...
  },
  {
    id: "htn_planning",
    label: "HtnPlanning",
    doc: `HTN planning — SHOP2-style total-order decomposition (Nau et al.`,
  ...
  },
  {
    id: "ilp",
    label: "Ilp",
    doc: `FOIL: top-down induction of first-order Horn clauses by information gain (Quinlan 1990, 'Learning logical definitions from relations', Machine Learning 5).`,
    citation: `Quinlan, J. R. (1990). Machine Learning, 5(3), 239-266.`,
  },
  {
    id: "ltl_monitor",
    label: "LtlMonitor",
    doc: `LTL runtime monitor — Havelund & Roşu 2001 progression (formula rewriting).`,
  ...
  },
  {
    id: "markov_logic",
    label: "MarkovLogic",
    doc: `Propositional Markov Logic Network MAP inference via MaxWalkSAT (Richardson & Domingos 2006, 'Markov logic networks', Machine Learning 62; MaxWalkSAT: Kautz, Selman & Jiang 1997).`,
    citation: `Matthew Richardson and Pedro Domingos (2006). Markov logic networks. Machine Learning 62(1-2):107-136.`,
  },
  {
    id: "mdp",
    label: "Mdp",
    doc: `MDP: value iteration to the Bellman fixed point (Bellman, 'Dynamic Programming', Princeton University Press, 1957).`,
  ...
  },
  {
    id: "meta_reasoning",
    label: "MetaReasoning",
    doc: `Meta-reasoning: cross-breed conflict detection and confidence-weighted resolution (Cox & Raja 2011, 'Metareasoning: Thinking about Thinking', MIT Press — the meta-level monitors object-level reasoners and arbitrates).`,
    citation: `Michael T. Cox and Anita Raja (eds.) (2011). Metareasoning: Thinking about Thinking. MIT Press.`,
  },
  {
    id: "morphological",
    label: "Morphological",
    doc: `Zwicky General Morphological Analysis with Cross-Consistency Assessment (Zwicky 1947, 'Morphology and nomenclature of jet engines', Aeronautical Engineering Review 6(6); Zwicky 1969, 'Discovery, Invention, Research Through the Morphological Approach'; Ritchey 2011, 'Wicked Problems — Social Messes', Springer, Chapter 2, DOI 10.1007/978-3-642-19653-9_2).`,
    citation: `Zwicky, F. (1969). Discovery, Invention, Research Through the Morphological Approach. Macmillan.`,
  },
  {
    id: "mycin",
    label: "Mycin",
    doc: `MYCIN-style forward-chaining rule engine with Shortliffe-Buchanan certainty-factor combination (Shortliffe 1976).`,
  ...
  },
  {
    id: "naive_physics",
    label: "NaivePhysics",
    doc: `Naive physics: hand-coded commonsense axiom saturation (Hayes 1979, 'The Naive Physics Manifesto'; Hayes 1985, 'Naive physics I: ontology for liquids').`,
  ...
  },
  {
    ...
    doc: `Object-Centric Process Mining (OCPM) Route Discoverer Discovers individual object lifecycles from object-centric event logs.`,
  ...
  },
  {
    ...
    doc: `SNLP partial-order planning (McAllester & Rosenblitt, 'Systematic Nonlinear Planning', AAAI 1991).`,
  ...
  },
  {
    id: "pomdp",
    label: "Pomdp",
    doc: `POMDP: exact Bayes belief update + bounded point-based value iteration (Kaelbling, Littman & Cassandra 1998, 'Planning and acting in partially observable stochastic domains', AIJ 101; PBVI: Pineau, Gordon & Thrun 2003).`,
  ...
  },
  {
    id: "problog",
    label: "Problog",
    doc: `ProbLog: probabilistic Horn logic by exact possible-worlds enumeration (De Raedt, Kimmig & Toivonen 2007, IJCAI).`,
    citation: `De Raedt, L., Kimmig, A., & Toivonen, H. (2007). Proceedings of IJCAI 2007, 2468-2473.`,
  },
  {
    id: "prolog",
    label: "Prolog",
    doc: `Breed: Prolog — flat-term Robinson unification over positional ?N variables.`,
  ...
  },
  {
    ...
    doc: `Qualitative reasoning: confluence propagation and envisionment (de Kleer & Brown, 'A Qualitative Physics Based on Confluences', Artificial Intelligence 24, 1984).`,
    citation: `de Kleer, J., & Brown, J. S. (1984). A Qualitative Physics Based on Confluences. Artificial Intelligence, 24(1–3), 7–83.`,
  },
  {
    id: "rl_symbolic",
    label: "RlSymbolic",
    doc: `Tabular Q-learning over a symbolic MDP (Watkins & Dayan 1992, 'Q-learning', Machine Learning 8).`,
    citation: `Watkins, C. J. C. H., & Dayan, P. (1992). Machine Learning, 8(3-4), 279-292.`,
  },
  {
    id: "sat_cdcl",
    label: "SatCdcl",
    doc: `CDCL SAT solver with 1-UIP conflict-driven clause learning (Marques-Silva & Sakallah 1999, GRASP, IEEE Trans.`,
    citation: `Marques-Silva, J. P., & Sakallah, K. A. (1999). IEEE Transactions on Computers, 48(5), 506-521.`,
  },
  {
    id: "script_sam",
    label: "ScriptSam",
    doc: `SAM: Script Applier Mechanism (Schank & Abelson, 'Scripts, Plans, Goals and Understanding', Lawrence Erlbaum, 1977).`,
  ...
  },
  {
    ...
    doc: `Situation calculus with Reiter successor-state axioms (Reiter 1991).`,
  ...
  },
  {
    id: "soar",
    label: "Soar",
    doc: `SOAR-style preference-based operator selection with impasse detection and bounded subgoaling (Laird 1987).`,
  ...
  },
  {
    id: "strips",
    label: "Strips",
    doc: `STRIPS-style precondition-based planner with iterative deepening goal-regression search (Fikes & Nilsson 1971).`,
  ...
  },
  {
    id: "tableaux",
    label: "Tableaux",
    doc: `Smullyan signed analytic tableaux for propositional validity (Smullyan 1968, 'First-Order Logic', Part I).`,
    citation: `Raymond M. Smullyan (1968). First-Order Logic. Springer-Verlag, Ergebnisse der Mathematik und ihrer Grenzgebiete 43.`,
  },
  {
    id: "triz",
    label: "Triz",
    doc: `Altshuller's TRIZ (Theory of Inventive Problem Solving) Contradiction Matrix and Inventive Principles.`,
    citation: `Altshuller, G. (1984). Creativity as an Exact Science. Gordon and Breach Science Publishers.`,
  },
  {
    id: "version_space",
    label: "VersionSpace",
    doc: `Version-space candidate elimination (Mitchell, 'Generalization as Search', Artificial Intelligence 18(2), 1982).`,
