...
/// Every registered cognition breed, in stable (id-sorted) order.
pub const CATALOG: &[BreedInfo] = &[
    BreedInfo {
        id: "abductive_ibe",
        label: "AbductiveIbe",
