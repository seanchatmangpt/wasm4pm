...
- Name: otel-lifecycle.spec.ts >> OTEL + WASM lifecycle >> wasm.run span emitted after algorithm run with algorithm and status
- Location: tests/e2e/otel-lifecycle.spec.ts:15:3
