...
import { SourceRegistry, sourceRegistry, } from '../src/index.js';
...
describe('SourceRegistry', () => {
    ...
    describe('list', () => {
        ...
        it('should return all registered adapters', () => {
            const adapter1 = new MockSourceAdapter();
            const adapter2 = new MockSourceAdapter();
            adapter2.kind = 'mock2'; // Change kind for uniqueness
            registry.register(adapter1);
...
//# sourceMappingURL=connectors.test.js.map