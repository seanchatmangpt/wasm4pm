#!/usr/bin/env bash
# chain.sh — smart-home breed chain orchestrator
# Runs 6 cognition stages: ltl_monitor -> allen_temporal -> fuzzy_logic -> csp_ac3
#                          -> htn_planning -> clp
set -euo pipefail
...
# ---------------------------------------------------------------------------
STAGES=(
  "0:0-ltl_monitor:ltl_monitor"
  "1:1-allen_temporal:allen_temporal"
  "2:2-fuzzy_logic:fuzzy_logic"
  "3:3-csp_ac3:csp_ac3"
  "4:4-htn_planning:htn_planning"
  "5:5-clp:clp"
)
