...
pub fn analyze_lead_time(repo_path: &str, days: usize) -> Result<LeadTimeMetrics> {
    ...
    lead_times.sort_unstable_by(|a: &f64, b| a.total_cmp(b));
...
mod tests {
    ...
    fn test_p95_ge_median_for_sorted_sequence() {
        ...
        times.sort_unstable_by(|a: &f64, b| a.total_cmp(b));
    ...
    fn test_adding_slow_outlier_raises_average_and_p95() {
        ...
        base_sorted.sort_unstable_by(|a: &f64, b| a.total_cmp(b));
        ...
        out_sorted.sort_unstable_by(|a: &f64, b| a.total_cmp(b));
