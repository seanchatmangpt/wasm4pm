...
import { verifyBellmanUpdate, verifyWesternElectricRules } from './oracle';
...
describe('Adversarial WvdA Algorithm Audit — Vitest Suite', () => {
    ...
    describe('Category A: Bellman Equation Correctness (Rank-1 Oracle)', () => {
        it('should not produce self-referential Q-updates (FM-1 detection)', () => {
            ...
            const result = verifyBellmanUpdate(mockUpdate.state, 'action', mockUpdate.reward, mockUpdate.nextState, mockUpdate.oldQ, mockUpdate.newQ);
    ...
    describe('Category H: Mutation Adequacy (Self-Referential Oracle)', () => {
        it('should detect when fitness formula is broken', () => {
            ...
            const correctFormula = (missing, remaining, consumed, produced) => 1 - (missing + remaining) / (consumed + produced);
...
//# sourceMappingURL=adversarial-wvda.bench.js.map