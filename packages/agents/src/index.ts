...
// mcpp → AgentOrchestrator bridge (closes GAP-1)
export { mcppEventToAuditEntry, ingestMcppJsonl } from './mcpp-bridge.js';
export type { IngestResult } from './mcpp-bridge.js';
