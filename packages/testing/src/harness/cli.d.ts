 ...
 *
 * Provides utilities to spawn wasm4pm as a child process, capture stdout/stderr,
...
/** Known exit codes — must match wasm4pm exit-codes.ts */
 ...
 */
export declare function writeTestConfig(
  dir: string,
 ...
 */
export declare function readReceipt(
  outputDir: string,
  filename?: string
