  ...
  const runDiscovery = useCallback(async () => {
    ...
    try {
      ...
      const result = {
        ...
        constraints:
          selectedAlgorithm === 'declare' ? Math.floor(Math.random() * 20) + 5 : undefined,
      };
            ...
            <>
              <section style={styles.analyticsGrid}>
                <div style={styles.card}>
                  <div style={styles.metric}>{analytics?.avgEventsPerTrace}</div>
                  <div style={styles.label}>Avg Events per Trace</div>
                </div>
                <div style={styles.card}>
                  <div style={styles.metric}>{log.activities.length}</div>
                  <div style={styles.label}>Unique Activities</div>
                </div>
                <div style={styles.card}>
                  <div style={styles.metric}>{analytics?.totalDiscoveries}</div>
              ...
              <section style={styles.section}>
                ...
                {results.length === 0 ? (
                  <p style={{ color: '#999' }}>
                    No discoveries yet. Run an algorithm to get started.
                  </p>
                ) : (
