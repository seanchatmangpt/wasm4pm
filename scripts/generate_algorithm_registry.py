#!/usr/bin/env python3
"""
generate_algorithm_registry.py — generates algorithm-registry.json for wasm4pm v26.5.15
...
Usage:
  python3 scripts/generate_algorithm_registry.py \
    ...
    --output target/wasm4pm-v26.5.15/algorithm-registry.json \
    --version 26.5.15
...
def parse_args():
    ...
    p.add_argument("--output", default="target/wasm4pm-v26.5.15/algorithm-registry.json")
