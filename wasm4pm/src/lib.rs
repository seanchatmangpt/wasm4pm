...
pub fn rl_orchestrator_get_telemetry() -> Result<JsValue, JsValue> {
    RL_ORCHESTRATOR.with(|orch| {
        ...
        js_sys::Reflect::set(
            &obj,
            &JsValue::from_str("last_health_state"),
        ...
        js_sys::Reflect::set(
            &obj,
            &JsValue::from_str("cumulative_reward"),
        ...
        js_sys::Reflect::set(
            &obj,
            &JsValue::from_str("last_spc_alert_count"),
