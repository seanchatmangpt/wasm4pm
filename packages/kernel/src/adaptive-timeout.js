...
const BASE_TIMEOUT_MS = 30000; // 30 seconds — reasonable for most algorithms
 ...
 * ```
 */
export function computeTimeout(factors) {
    ...
    const eventFactorMs = (eventCount / 10000) * EVENT_FACTOR_MS_PER_10K;
 ...
 */
export function classifyComplexity(eventCount, distinctActivities, numTraces) {
 ...
 */
export function detectAlgorithmTier(algorithmName) {
