...
REAL_DATA_REPORT="${REAL_DATA_REPORT:-wasm4pm/target/wasm4pm-v26.6.5/real-data-report.json}"
FAKE_AUDIT="${FAKE_AUDIT:-wasm4pm/target/wasm4pm-v26.6.5/fake-stub-audit.json}"
OUTPUT_FILE="${OUTPUT_FILE:-wasm4pm/target/wasm4pm-v26.6.5/substrate-certificate.json}"
RELEASE="${RELEASE:-26.6.5}"
