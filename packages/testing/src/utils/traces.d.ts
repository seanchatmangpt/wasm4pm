 ...
 * or different traces.
 */
export declare function compareTraces(trace1: Trace | string[], trace2: Trace | string[]): TraceComparison;
/**
 * Check if two traces are identical (same activities in same order).
 */
export declare function areTracesIdentical(trace1: Trace | string[], trace2: Trace | string[]): boolean;
/**
 * Check if one trace is a permutation of another (same activities, different order).
 */
export declare function areTracesPermutation(trace1: Trace | string[], trace2: Trace | string[]): boolean;
/**
 * Check if a trace is a permutation of another and find the permutation sequence.
 */
export declare function findTracePermutation(original: string[], permuted: string[]): TracePermutationResult;
/**
 ...
 */
export declare function isTraceComplete(trace: Trace, options?: {
    requireStart?: string;
    requireEnd?: string;
}): boolean;
/**
