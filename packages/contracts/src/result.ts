...
export interface ProvenanceChain {
  readonly input_hash: string; // BLAKE3 hex-64
  readonly config_hash: string; // BLAKE3 hex-64
  readonly plan_hash: string; // BLAKE3 hex-64
  readonly output_hash: string; // BLAKE3 hex-64
