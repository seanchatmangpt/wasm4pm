%% Chapter 3 — Complete Test Suites and the Unfakeable Oracle Theorem

\chapter{Complete Test Suites and the Unfakeable Oracle Theorem}
\label{chap:oracle}

\epigraph{%
  ``The criterion of the scientific status of a theory is its falsifiability,
  or refutability, or testability.''
}{--- Karl Popper, \textit{The Logic of Scientific Discovery}, 1959}
...
% ─────────────────────────────────────────────────────────────────────────────
\section{The Unfakeable Oracle Theorem}
\label{sec:oracle-theorem}
% ─────────────────────────────────────────────────────────────────────────────

\begin{theorem}[Unfakeable Oracle]
\label{thm:oracle}
...
\mathcal{T}$ such that no finite lookup table, no memoised dictionary, and
no algorithmically simpler function can pass $\mathcal{T}_i$.  The nine
canonical witnesses follow.
\end{theorem}
...
\medskip\noindent
\textbf{(i) $\MYCIN$ Certainty-Factor Boundary.}
...
\medskip\noindent
\textbf{(ii) $\PROLOG$ Grandparent Derivation.}
...
\medskip\noindent
\textbf{(iii) $\STRIPS$ Plan Soundness.}
...
\medskip\noindent
\textbf{(vi) $\HEARSAY$ KSAR Opportunistic Scheduling.}
...
\medskip\noindent
\textbf{(vii) $\DENDRAL$ Forbid Absoluteness.}
...
\medskip\noindent
\textbf{(viii) $\GPS$ Difference-Table Coverage.}
...
\medskip\noindent
\textbf{(ix) $\ELIZA$ Keystack Priority.}
