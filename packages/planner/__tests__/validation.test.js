...
import { validatePlan, assertPlanValid } from '../src/validation';
...
describe('Plan Validation', () => {
    ...
    describe('validatePlan()', () => {
        ...
        it('should warn on invalid profile', () => {
            ...
            const errors = validatePlan(badPlan);
            expect(errors.some((e) => e.path.includes('profile') && e.severity === 'warning')).toBe(true);
        });
    ...
    describe('assertPlanValid()', () => {
        ...
        it('should throw for invalid plan', () => {
            ...
            expect(() => assertPlanValid(badPlan)).toThrow();
        });
