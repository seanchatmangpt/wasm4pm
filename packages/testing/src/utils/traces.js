 ...
 */
export function areTracesIdentical(trace1, trace2) {
 ...
 */
export function areTracesPermutation(trace1, trace2) {
    const comparison = compareTraces(trace1, trace2);
 ...
 */
export function findTracePermutation(original, permuted) {
 ...
 */
export function generateAllPermutations(activities) {
 ...
 */
export function isTraceComplete(trace, options = {}) {
 ...
 */
export function validateTraceTimestamps(trace) {
    const errors = [];
 ...
 */
export function hasDuplicateConsecutiveActivities(trace) {
    const positions = [];
 ...
 */
export function hasSelfLoops(trace) {
 ...
 */
export function computeTraceStatistics(traces) {
    if (traces.length === 0) {
        return {
            count: 0,
            minLength: 0,
 ...
 */
export function getUniqueActivities(traces) {
 ...
 */
export function computeActivityFrequency(traces) {
 ...
 */
export function findMostCommonVariant(traces) {
    if (traces.length === 0)
        return null;
 ...
 * Create a test trace.
 */
export function createTestTrace(activities, caseId = 'test-case') {
    return {
        caseId,
        activities,
 ...
 */
export function formatTraceComparison(comparison) {
    const lines = [];
 ...
 */
export function traceToArray(trace) {
    return [...trace.activities];
}
/**
 * Convert string array to trace.
 */
export function arrayToTrace(activities, caseId = 'trace') {
    return {
        caseId,
        activities,
    };
 ...
 */
export function isSubsequence(subsequence, trace) {
    let subIdx = 0;
 ...
 */
export function longestCommonSubsequence(trace1, trace2) {
 ...
 */
export function traceSimilarity(trace1, trace2) {
