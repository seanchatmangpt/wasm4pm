...
Berry--Esseen theorem bounds the Kolmogorov--Smirnov distance between the empirical
distribution over $k$ samples and the true posterior by $C / \sqrt{k}$ for a universal
constant $C > 0$.  This bound falls below $\varepsilon$ if and only if $k \geq C^2 / \varepsilon^2$,
