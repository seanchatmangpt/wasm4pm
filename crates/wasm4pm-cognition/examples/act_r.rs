...
fn main() {
    ...
    let input = BreedInput {
        ...
        facts: vec![
            Fact {
                key: "task".to_string(),
                value: "solve-equation".to_string(),
            },
            Fact {
                key: "step".to_string(),
            ...
            Case {
                ...
                facts: vec![
                    ...
                    Fact {
                        ...
                        value: "linear-equation".to_string(),
                    },
                ],
            },
            Case {
                ...
                facts: vec![
                    ...
                    Fact {
                        key: "step".to_string(),
                        value: "factoring".to_string(),
                    },
                    Fact {
                        key: "concept".to_string(),
                        value: "quadratic".to_string(),
                    },
                ],
            },
            Case {
