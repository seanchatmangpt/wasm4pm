...
G3 & Quality-Threshold & Quality metrics meet thresholds: fitness $\geq 0.95$,
...
G3 Quality-Threshold &            & \checkmark &            &            & \checkmark &            \\
...
\[
  \text{fitness} = 0.5 \times \left(1 - \frac{m}{\max(1,c)}\right) + 0.5 \times \left(1 - \frac{r}{\max(1,p)}\right)
\]
...
$5 \times 8 \times 8 \times 4 \times 3 \times 8 \times 3 \times 4 = 368{,}640$ states.
...
\subsection{G3: Quality-Threshold Gate}
