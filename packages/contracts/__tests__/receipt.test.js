...
import { isReceipt } from '../src/receipt';
...
describe('Receipt types', () => {
    ...
    describe('Receipt fields', () => {
        ...
        it('should have optional artifacts in model', () => {
            ...
            expect(receiptWithArtifacts.model.artifacts?.petri_net).toBe('/output/model.pnml');
        });
    ...
    describe('Receipt structure', () => {
        ...
        it('should support nested objects in parameters', () => {
            const receipt = new ReceiptBuilder()
                ...
                .setModel({})
                .build();
            expect(receipt.algorithm.parameters.fitness.type).toBe('edges');
        });
    });
});
