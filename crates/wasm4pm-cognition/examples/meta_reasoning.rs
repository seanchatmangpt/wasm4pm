...
fn main() {
    let input = BreedInput {
        ...
        facts: vec![
            ...
            Fact {
                key: "breed:mycin:conclusion".to_string(),
                value: "therapy=gentamicin".to_string(),
            },
            Fact {
                key: "breed:mycin:confidence".to_string(),
                value: "0.85".to_string(),
            },
            // prolog: moderate-confidence contradicting recommendation
            Fact {
                key: "breed:prolog:conclusion".to_string(),
                value: "therapy=vancomycin".to_string(),
            },
            Fact {
                key: "breed:prolog:confidence".to_string(),
                value: "0.60".to_string(),
            },
            // bayesian_network: lower-confidence, agrees with mycin
            Fact {
                key: "breed:bayesian_network:conclusion".to_string(),
                value: "therapy=gentamicin".to_string(),
            },
            Fact {
                key: "breed:bayesian_network:confidence".to_string(),
                value: "0.70".to_string(),
            },
        ],
        cases: vec![],
        rules: vec![],
    ...
    match run_breed(&breed, &input) {
        Ok(output) => {
            ...
            println!(
                "meta_reasoning ok — selected={:?}  hash={}",
                output.selected,
                &output_hash[..16]
            );
