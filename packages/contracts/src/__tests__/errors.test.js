...
import { createError, formatError, formatErrorJSON, logError, validateErrorSystem, } from '../errors.js';
describe('Error System - PRD §14', () => {
    ...
    describe('error formatting', () => {
        let testError;
        beforeAll(() => {
            testError = createError('SOURCE_NOT_FOUND', 'Input file not found at /data/log.xes', { path: '/data/log.xes', searched: ['/data', '/var/data'] });
        });
    ...
    describe('error remediation clarity', () => {
        ...
        allErrorCodes.forEach((code) => {
            it(`${code} remediation is actionable`, () => {
                ...
                const hasAction = remediation.includes('check') ||
    ...
    describe('error context handling', () => {
        ...
        it('handles null/undefined context gracefully', () => {
            ...
            const error2 = createError('CONFIG_MISSING', 'test', null);
