...
describe('Prediction Additions', () => {
    ...
    describe('9. Boundary Coverage', () => {
        it('should estimate completion probability', () => {
            ...
            const prefix = ['A', 'B'];
            const matching = allTraces.filter((t) => t.length >= prefix.length && t.slice(0, prefix.length).every((a, i) => a === prefix[i]));
...
//# sourceMappingURL=additions.test.js.map