 ...
 */
export function extractFootprintsFromLog(eventLog) {
    ...
    const precedenceCounts = new Map();
    const successionCounts = new Map();
 ...
 */
function canReachInDFG(dfg, source, target) {
 ...
 */
function extractActivities(eventLog) {
 ...
 */
export function compareFootprints(fp1, fp2) {
 ...
 */
export function areFootprintsEquivalent(fp1, fp2) {
 ...
 */
export function formatFootprints(fp) {
    const lines = [];
 ...
 */
function relationToSymbol(relation) {
    switch (relation) {
        case 'sequence':
            return '->';
        case 'parallel':
 ...
 */
export function formatFootprintComparison(comparison) {
    const lines = [];
 ...
 */
export function createSequentialFootprint() {
 ...
 */
export function createParallelFootprint() {
 ...
 */
export function createChoiceFootprint() {
    const activities = ['A', 'B', 'C', 'D'];
    const matrix = new Map();
    for (const a of activities) {
        matrix.set(a, new Map());
 ...
 */
export function serializeFootprints(fp) {
    const obj = {
 ...
 */
export function deserializeFootprints(json) {
 ...
 */
export function computeFootprintEntropy(fp) {
