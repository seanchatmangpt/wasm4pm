...
fn main() {
    let input = BreedInput {
        ...
        facts: vec![
            ...
            Fact {
                key: "clause:1".to_string(),
                value: "x1,x2,-x3".to_string(),
            },
            Fact {
                key: "clause:2".to_string(),
                value: "-x1,x3".to_string(),
            },
            Fact {
                key: "clause:3".to_string(),
                value: "-x2,-x3".to_string(),
            },
        ],
        cases: vec![],
        rules: vec![],
