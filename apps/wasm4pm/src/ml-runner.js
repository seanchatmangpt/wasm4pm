 ...
 */
export async function executeMlTask(wasm, task, logHandle, activityKey, options = {}) {
    switch (task) {
        case 'classify': {
            ...
            const rawFeatures = wasm.extract_case_features(logHandle, activityKey, 'time:timestamp', configJson);
...
//# sourceMappingURL=ml-runner.js.map