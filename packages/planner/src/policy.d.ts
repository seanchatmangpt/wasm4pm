 ...
 */
export declare function selectEngineByPriority(algorithmId: AlgorithmId, budget: BudgetEnvelope, pythonAvailable: boolean, algorithmFamily?: AlgorithmFamily): BackendId | null;
/**
 ...
 */
export declare function selectAlgorithmByBudget(latencyBudget: LatencyClass, qualityFloor: QualityTier): AlgorithmId[];
/**
 ...
 */
export declare function shouldPromoteJob(priorLatencyMs: number, priorLatencyBudget: LatencyClass, newBudget: BudgetEnvelope, conformanceScore: number, spcAlertLevel: number, priorSpcAlertLevel: number, healthLevel: number, priorHealthLevel: number): boolean;
/**
 ...
 */
export declare function shouldDegradeAlgorithm(priorLatencyMs: number, latencyBudgetMs: number, priorMemoryBytes: number, memoryBudgetBytes: number, circuitOpen: boolean, backendHealthy: boolean, spcViolation: boolean): boolean;
/**
 ...
 */
export declare function profileToExecutionMode(profile: 'fast' | 'balanced' | 'quality' | 'stream', eventCount?: number, algorithmId?: string): 'online' | 'near-online' | 'batch' | 'research';
/**
 * Helper to convert execution profile to latency budget.
 * Used by the planner to derive latencyBudget from profile.
 */
export declare function profileToLatencyBudget(profile: 'fast' | 'balanced' | 'quality' | 'stream'): LatencyClass;
/**
 * Helper to convert execution profile to quality floor.
 * Used by the planner to derive qualityFloor from profile.
 */
export declare function profileToQualityFloor(profile: 'fast' | 'balanced' | 'quality' | 'stream'): QualityTier;
