 ...
 */
export function createDFG(eventLog) {
    const nodes = new Set();
    const edges = new Map();
 ...
 */
export function createDFGFromEdges(edges, options = {}) {
    const nodes = new Set();
 ...
 */
export function compareDFGs(df1, df2) {
    // Node comparison
 ...
 */
export function areDFGsEquivalent(df1, df2) {
 ...
 */
export function validateDFG(dfg) {
    const errors = [];
    // Check nodes
 ...
 */
export function validateDFGConsistency(dfg, eventLog) {
    const errors = [];
 ...
 */
export function computeDFGDensity(dfg) {
 ...
 */
export function computeAverageNodeDegree(dfg) {
    if (dfg.nodes.length === 0)
        return 0;
 ...
 */
export function findLongestPath(dfg) {
    if (dfg.nodes.length === 0)
        return [];
 ...
 */
export function createSequentialTestDFG() {
 ...
 */
export function createParallelTestDFG() {
    return createDFGFromEdges([
        { source: 'A', target: 'B', count: 10 },
 ...
 */
export function createChoiceTestDFG() {
    return createDFGFromEdges([
 ...
 */
export function createTestEventLogForDFG() {
    return [
        { activities: ['A', 'B', 'C', 'D'] },
        { activities: ['A', 'B', 'C', 'D'] },
        { activities: ['A', 'B', 'C', 'D'] },
 ...
 */
export function formatDFGComparison(comparison) {
    const lines = [];
 ...
 */
export function serializeDFG(dfg) {
 ...
 */
export function deserializeDFG(json) {
