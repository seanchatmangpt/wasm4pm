#!/usr/bin/env bash
# chain.sh — cognitive-memory breed chain orchestrator
set -euo pipefail
...
STAGES=(
  "0:0-script_sam:script_sam"
  "1:1-episodic_memory:episodic_memory"
  "2:2-act_r:act_r"
  "3:3-analogy_sme:analogy_sme"
  "4:4-ebl:ebl"
  "5:5-version_space:version_space"
)
