...
export function discover_ml_classify(eventlog_handle: string, activity_key: string): any;

export function discover_ml_forecast(eventlog_handle: string, activity_key: string): any;

export function discover_ml_pca(eventlog_handle: string, activity_key: string): any;

export function discover_ml_regress(eventlog_handle: string, activity_key: string): any;
 ...
 */
export function wasm_reduce_petri_net(net_handle: string): string;
...
export interface InitOutput {
    ...
    readonly __wbg_get_rlstate_activity_count_q: (a: number) => number;
    readonly __wbg_get_rlstate_circuit_state: (a: number) => number;
    readonly __wbg_get_rlstate_cycle_phase: (a: number) => number;
    readonly __wbg_get_rlstate_drift_status: (a: number) => number;
    readonly __wbg_get_rlstate_event_rate_q: (a: number) => number;
    readonly __wbg_get_rlstate_health_level: (a: number) => number;
    readonly __wbg_get_rlstate_rework_ratio_q: (a: number) => number;
    readonly __wbg_get_rlstate_spc_alert_level: (a: number) => number;
    readonly __wbg_operationresult_free: (a: number, b: number) => void;
    readonly __wbg_rlstate_free: (a: number, b: number) => void;
    readonly __wbg_set_rlstate_activity_count_q: (a: number, b: number) => void;
    readonly __wbg_set_rlstate_circuit_state: (a: number, b: number) => void;
    readonly __wbg_set_rlstate_cycle_phase: (a: number, b: number) => void;
    readonly __wbg_set_rlstate_drift_status: (a: number, b: number) => void;
    readonly __wbg_set_rlstate_event_rate_q: (a: number, b: number) => void;
    readonly __wbg_set_rlstate_health_level: (a: number, b: number) => void;
    readonly __wbg_set_rlstate_rework_ratio_q: (a: number, b: number) => void;
    readonly __wbg_set_rlstate_spc_alert_level: (a: number, b: number) => void;
    readonly __wbg_wasmeventlog_free: (a: number, b: number) => void;
    readonly advanced_algorithms_info: () => [number, number];
    readonly align_etconformance_precision: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly alignment_fitness: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly analyze_activity_cooccurrence: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly analyze_activity_dependencies: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly analyze_case_attributes: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly analyze_case_duration: (a: number, b: number) => [number, number, number];
    readonly analyze_dotted_chart: (a: number, b: number) => [number, number, number];
    readonly analyze_event_statistics: (a: number, b: number) => [number, number, number];
    readonly analyze_infrequent_paths: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly analyze_oc_performance: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly analyze_ocel_statistics: (a: number, b: number) => [number, number, number];
    readonly analyze_process_speedup: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly analyze_resource_activity_matrix: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly analyze_resource_utilization: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly analyze_start_end_activities: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly analyze_temporal_bottlenecks: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly analyze_trace_variants: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly analyze_variant_complexity: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly available_analysis_functions: () => [number, number];
    readonly available_discovery_algorithms: () => any;
    readonly build_ngram_predictor: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly build_remaining_time_model: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly build_transition_probabilities: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly calculate_trace_durations: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly check_data_quality: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly check_declare_conformance: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly check_dg_soundness: (a: number, b: number) => [number, number, number, number];
    readonly check_ocel_data_quality: (a: number, b: number) => [number, number, number];
    readonly check_powl_soundness: (a: number, b: number) => [number, number, number, number];
    readonly check_temporal_conformance: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
    readonly check_token_based_replay: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly clear_all_caches: () => void;
    readonly clear_all_objects: () => [number, number];
    readonly cluster_traces: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly compute_activity_transition_matrix: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly compute_alignments: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly compute_boundary_coverage: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly compute_ewma: (a: number, b: number, c: number) => [number, number, number];
    readonly compute_feature_importance: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly compute_model_metrics: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly compute_optimal_alignments: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
    readonly compute_rework_score: (a: number, b: number) => [number, number, number];
    readonly compute_trace_likelihood: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly compute_trace_similarity_matrix: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly conformance_cache_clear: (a: number, b: number) => [number, number, number];
    readonly conformance_cache_get: (a: number, b: number, c: number, d: number, e: bigint) => [number, number, number];
    readonly conformance_cache_hash_model: (a: number, b: number) => [number, number, number];
    readonly conformance_cache_insert: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number, h: number, i: number) => [number, number, number];
    readonly conformance_cache_new: () => [number, number];
    readonly conformance_cache_stats: (a: number, b: number) => [number, number, number];
    readonly conformance_info: () => [number, number];
    readonly create_rl_state: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
    readonly create_streaming_log: () => number;
    readonly delete_object: (a: number, b: number) => [number, number, number];
    readonly detect_bottlenecks: (a: number, b: number, c: number, d: number, e: number, f: number, g: bigint) => [number, number, number];
    readonly detect_concept_drift: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly detect_drift: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly detect_rework: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly diff_models: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly discover_aco_algorithm: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly discover_alpha_plus_plus: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly discover_astar: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly discover_batches_wasm: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly discover_causal_alpha: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_causal_heuristic: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly discover_correlation: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly discover_declare: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_dfg: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_dfg_filtered: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly discover_dfg_handle: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_dfg_hierarchical: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly discover_dfg_hierarchical_by_events: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly discover_dfg_simd: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_dfg_simd_handle: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_genetic_algorithm: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly discover_handover_network: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_heuristic_miner: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly discover_hill_climbing: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_ilp_petri_net: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_inductive_miner: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_ml_classify: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_ml_forecast: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_ml_pca: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_ml_regress: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_oc_petri_net: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_ocel_dfg: (a: number, b: number) => [number, number, number];
    readonly discover_ocel_dfg_per_type: (a: number, b: number) => [number, number, number];
    readonly discover_ocel_powl: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_optimized_dfg: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly discover_performance_dfg: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly discover_performance_spectrum_wasm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
    readonly discover_powl_from_log: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_powl_from_log_config: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
    readonly discover_powl_from_partial_orders: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_prefix_tree: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly discover_pso_algorithm: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly discover_simple_process_tree: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discover_simulated_annealing: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly discover_temporal_profile: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly discover_transition_system_from_handle: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly discover_working_together_network: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly discovery_info: () => any;
    readonly encode_bottlenecks_as_text: (a: number, b: number) => [number, number, number, number];
    readonly encode_conformance_as_text: (a: number, b: number) => [number, number, number, number];
    readonly encode_dfg_as_text: (a: number, b: number) => [number, number, number, number];
    readonly encode_model_comparison_as_text: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly encode_oc_petri_net_as_text: (a: number, b: number) => [number, number, number, number];
    readonly encode_ocel_as_text: (a: number, b: number) => [number, number, number, number];
    readonly encode_ocel_summary_as_text: (a: number, b: number) => [number, number, number, number];
    readonly encode_petri_net_as_text: (a: number, b: number) => [number, number, number, number];
    readonly encode_statistics_as_text: (a: number, b: number) => [number, number, number, number];
    readonly encode_variants_as_text: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    readonly ensemble_discover: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly estimate_queue_delay: (a: number, b: number) => [number, number, number];
    readonly export_dfg_to_json: (a: number, b: number) => [number, number, number, number];
    readonly export_eventlog_to_json: (a: number, b: number) => [number, number, number, number];
    readonly export_eventlog_to_xes: (a: number, b: number) => [number, number, number, number];
    readonly export_features_csv: (a: number, b: number) => [number, number, number, number];
    readonly export_features_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
    readonly export_ocel2_to_json: (a: number, b: number) => [number, number, number, number];
    readonly export_ocel_to_json: (a: number, b: number) => [number, number, number, number];
    readonly export_petri_net_to_json: (a: number, b: number) => [number, number, number, number];
    readonly extract_activity_ordering: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly extract_case_features: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
    readonly extract_prefix_features: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly extract_prefix_features_wasm: (a: number, b: number) => [number, number, number];
    readonly extract_process_skeleton: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly fast_discovery_info: () => [number, number];
    readonly filter_by_case_ids: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_by_case_performance: (a: number, b: number, c: bigint, d: bigint, e: number, f: number) => [number, number, number];
    readonly filter_by_case_size: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly filter_by_directly_follows: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_by_end_activity: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_by_event_attribute_value: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_by_start_activity: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_by_time_range: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
    readonly filter_by_trace_attribute: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_by_variant_coverage: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly filter_by_variants_top_k: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly filter_log_by_activity: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_log_by_trace_length: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly filter_rework_traces: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly filter_traces_containing_activities: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_traces_ending_with_sequence: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_traces_excluding_activities: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly filter_traces_starting_with_sequence: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly final_analytics_info: () => [number, number];
    readonly flatten_ocel_to_eventlog: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly footprints_conformance: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly free_streaming_log: (a: number) => [number, number];
    readonly from_pnml_wasm: (a: number, b: number) => [number, number, number];
    readonly generalization: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly generate_recommendations: (a: number, b: number) => [number, number, number];
    readonly genetic_discovery_info: () => [number, number];
    readonly get_activities: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly get_activity_frequencies: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly get_attribute_names: (a: number, b: number) => [number, number, number];
    readonly get_cache_stats: () => [number, number];
    readonly get_capabilities: () => [number, number];
    readonly get_capability_registry: () => [number, number, number];
    readonly get_children: (a: number, b: number, c: number) => [number, number, number];
    readonly get_drift_thresholds: () => [number, number];
    readonly get_event_count: (a: number, b: number) => [number, number, number];
    readonly get_io_info: () => [number, number];
    readonly get_ocel_event_count: (a: number, b: number) => [number, number, number];
    readonly get_ocel_object_count: (a: number, b: number) => [number, number, number];
    readonly get_ocel_type_statistics: (a: number, b: number) => [number, number, number];
    readonly get_trace_count: (a: number, b: number) => [number, number, number];
    readonly get_trace_length_statistics: (a: number, b: number) => [number, number, number];
    readonly get_trace_lengths: (a: number, b: number) => [number, number, number];
    readonly get_version: () => [number, number];
    readonly global_feature_importance: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly identify_resource_bottlenecks: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
    readonly ilp_discovery_info: () => [number, number];
    readonly incremental_dfg_snapshot: (a: number, b: number) => [number, number, number, number];
    readonly incremental_dfg_stats: (a: number, b: number) => [number, number, number, number];
    readonly infer_eventlog_schema: (a: number, b: number) => [number, number, number];
    readonly infer_ocel_schema: (a: number, b: number) => [number, number, number];
    readonly init: () => [number, number, number, number];
    readonly list_ocel_object_types: (a: number, b: number) => [number, number, number];
    readonly load_eventlog_from_json: (a: number, b: number) => [number, number, number, number];
    readonly load_eventlog_from_xes: (a: number, b: number) => [number, number, number, number];
    readonly load_eventlog_from_xes_cached: (a: number, b: number) => [number, number, number, number];
    readonly load_ocel2_from_json: (a: number, b: number) => [number, number, number, number];
    readonly load_ocel_from_json: (a: number, b: number) => [number, number, number, number];
    readonly load_ocel_from_xml: (a: number, b: number) => [number, number, number, number];
    readonly main: () => void;
    readonly measure_complexity: (a: number, b: number) => [number, number, number, number];
    readonly mine_sequential_patterns: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly monte_carlo_simulation: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
    readonly more_discovery_info: () => [number, number];
    readonly new_streaming_dfg: () => [number, number, number, number];
    readonly node_info_json: (a: number, b: number, c: number) => [number, number, number, number];
    readonly node_to_string: (a: number, b: number, c: number) => [number, number, number, number];
    readonly object_count: () => [number, number, number];
    readonly oc_conformance_check: (a: number, b: number) => [number, number, number];
    readonly oc_conformance_info: () => any;
    readonly oc_performance_analysis: (a: number, b: number) => [number, number, number];
    readonly oc_performance_info: () => any;
    readonly oc_petri_net_info: () => any;
    readonly operationresult_data: (a: number) => [number, number];
    readonly operationresult_is_success: (a: number) => number;
    readonly operationresult_message: (a: number) => [number, number];
    readonly parallel_available: () => number;
    readonly parallel_discover_dfg: (a: number, b: number, c: number, d: number) => [number, number];
    readonly parallel_run_algorithms: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    readonly parse_powl: (a: number, b: number) => [number, number, number];
    readonly petri_net_playout: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly petri_net_to_powl: (a: number, b: number) => [number, number, number];
    readonly pipeline_add_event: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly pipeline_begin: (a: number, b: number) => [number, number, number, number];
    readonly pipeline_close_trace: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly pipeline_finalize: (a: number, b: number) => [number, number, number];
    readonly pipeline_snapshot: (a: number, b: number) => [number, number, number];
    readonly pipeline_stats: (a: number, b: number) => [number, number, number];
    readonly play_out_dfg: (a: number, b: number, c: any) => [number, number, number];
    readonly play_out_process_tree: (a: number, b: number, c: number, d: any) => [number, number, number];
    readonly pm4bin_info: (a: number, b: number) => [number, number, number, number];
    readonly powl_extensive_playout: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly powl_footprints: (a: number, b: number) => [number, number, number, number];
    readonly powl_to_bpmn: (a: number, b: number) => [number, number, number, number];
    readonly powl_to_petri_net: (a: number, b: number) => [number, number, number, number];
    readonly powl_to_process_tree: (a: number, b: number) => [number, number, number, number];
    readonly powl_to_string: (a: number, b: number) => [number, number, number, number];
    readonly powl_to_svg: (a: number, b: number) => [number, number, number, number];
    readonly predict_beam_paths: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly predict_case_duration: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly predict_hazard_rate: (a: number, b: number, c: number) => [number, number, number];
    readonly predict_next_activity: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly predict_next_k: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly process_tree_to_powl: (a: number, b: number) => [number, number, number];
    readonly rank_interventions: (a: number, b: number, c: number) => [number, number, number];
    readonly read_bpmn: (a: number, b: number) => [number, number, number, number];
    readonly read_pm4bin: (a: number, b: number) => [number, number, number, number];
    readonly recommendations_info: () => any;
    readonly reset_drift_thresholds: () => [number, number];
    readonly rl_state_from_features: (a: number, b: number, c: number, d: number) => number;
    readonly rl_state_health_level: (a: number) => number;
    readonly score_anomaly: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly score_log_anomalies: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly score_trace_anomaly: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly score_trace_likelihood: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly select_intervention: (a: number, b: number, c: number) => [number, number, number];
    readonly set_drift_thresholds: (a: number, b: number) => [number, number, number, number];
    readonly simd_streaming_dfg_info: () => any;
    readonly simd_token_replay: (a: number, b: number, c: number, d: number) => [number, number];
    readonly simplify_frequent_transitions: (a: number, b: number) => [number, number, number];
    readonly simplify_powl: (a: number, b: number) => [number, number, number];
    readonly smart_engine_cache_stats: (a: number, b: number) => [number, number, number, number];
    readonly smart_engine_check_convergence: (a: number, b: number, c: number) => [number, number, number];
    readonly smart_engine_converged: (a: number, b: number) => [number, number, number];
    readonly smart_engine_create: () => [number, number];
    readonly smart_engine_create_with_params: (a: number, b: number, c: number, d: number) => [number, number];
    readonly smart_engine_destroy: (a: number, b: number) => [number, number];
    readonly smart_engine_reset: (a: number, b: number) => [number, number];
    readonly smart_engine_run: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    readonly store_declare_from_json: (a: number, b: number) => [number, number, number];
    readonly store_dfg_from_json: (a: number, b: number) => [number, number, number];
    readonly streaming_conformance_add_event: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly streaming_conformance_begin: (a: number, b: number) => [number, number, number];
    readonly streaming_conformance_close_trace: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly streaming_conformance_finalize: (a: number, b: number) => [number, number, number];
    readonly streaming_conformance_stats: (a: number, b: number) => [number, number, number];
    readonly streaming_dfg_add_batch: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly streaming_dfg_add_event: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly streaming_dfg_begin: () => [number, number, number];
    readonly streaming_dfg_close_trace: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly streaming_dfg_end_trace: (a: number, b: number) => [number, number];
    readonly streaming_dfg_finalize: (a: number, b: number) => [number, number, number];
    readonly streaming_dfg_flush_open: (a: number, b: number) => [number, number, number];
    readonly streaming_dfg_process_event: (a: number, b: number, c: number) => [number, number];
    readonly streaming_dfg_snapshot: (a: number, b: number) => [number, number, number];
    readonly streaming_dfg_stats: (a: number, b: number) => [number, number, number];
    readonly streaming_dfg_string_end_trace: (a: number, b: number) => [number, number, number];
    readonly streaming_dfg_string_event: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly streaming_dfg_string_new: () => [number, number, number, number];
    readonly streaming_dfg_string_snapshot: (a: number, b: number) => [number, number, number, number];
    readonly streaming_heuristic_add_event: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly streaming_heuristic_begin: (a: number) => [number, number, number];
    readonly streaming_heuristic_close_trace: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly streaming_heuristic_finalize: (a: number, b: number) => [number, number, number];
    readonly streaming_heuristic_snapshot: (a: number, b: number) => [number, number, number];
    readonly streaming_info: () => [number, number];
    readonly streaming_log_activity_count: (a: number) => [number, number, number];
    readonly streaming_log_add_trace: (a: number, b: any) => [number, number];
    readonly streaming_log_estimate_cardinality: (a: number) => [number, number, number];
    readonly streaming_log_estimate_dfg: (a: number) => [number, number, number];
    readonly streaming_log_event_count: (a: number) => [number, number, number];
    readonly streaming_log_memory_bytes: (a: number) => [number, number, number];
    readonly streaming_skeleton_add_event: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly streaming_skeleton_begin: (a: number) => [number, number, number];
    readonly streaming_skeleton_close_trace: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly streaming_skeleton_finalize: (a: number, b: number) => [number, number, number];
    readonly streaming_skeleton_snapshot: (a: number, b: number) => [number, number, number];
    readonly to_pnml_wasm: (a: number, b: number) => [number, number, number];
    readonly token_replay_fitness: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly validate_has_activities: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly validate_has_timestamps: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly validate_ocel: (a: number, b: number) => [number, number, number];
    readonly validate_partial_orders: (a: number, b: number) => [number, number, number];
    readonly validate_process_tree: (a: number, b: number) => [number, number, number];
    readonly wasm_compute_precision: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    readonly wasm_compute_simplicity: (a: number, b: number, c: number) => number;
    readonly wasm_reduce_petri_net: (a: number, b: number) => [number, number, number, number];
    readonly wasmeventlog_attribute_count: (a: number) => [number, number, number];
    readonly wasmeventlog_case_count: (a: number) => [number, number, number];
    readonly wasmeventlog_event_count: (a: number) => [number, number, number];
    readonly wasmeventlog_handle: (a: number) => [number, number];
    readonly wasmeventlog_new: (a: number, b: number) => number;
    readonly wasmeventlog_stats: (a: number) => [number, number, number];
    readonly wasmocel_event_count: (a: number) => [number, number, number];
    readonly wasmocel_object_count: (a: number) => [number, number, number];
    readonly wasmocel_stats: (a: number) => [number, number, number];
    readonly write_pm4bin: (a: number, b: number) => [number, number, number, number];
    readonly xes_format_info: () => [number, number];
    readonly discover_ant_colony: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly wasmocel_new: (a: number, b: number) => number;
    readonly __wbg_wasmocel_free: (a: number, b: number) => void;
    readonly wasmocel_handle: (a: number) => [number, number];
