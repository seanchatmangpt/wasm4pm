...
export class LabRunner {
    ...
    withTimeout(promise, timeoutMs) {
        return Promise.race([
            promise,
            new Promise((_, reject) => setTimeout(() => reject(new Error(`Test timeout after ${timeoutMs}ms`)), timeoutMs)),
        ]);
    }
    /**
     ...
     * Save report to file
     */
    saveReport(report, outputDir = "reports") {
     ...
     */
    loadBaseline(fixturesDir = "fixtures") {
