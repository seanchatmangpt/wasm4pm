 ...
 */
export function isKernelError(err) {
 ...
 */
export function classifyRustError(raw) {
 ...
 */
export function toTypedError(raw, algorithmId) {
 ...
 */
export async function wrapKernelCall(fn, context) {
    try {
        return await fn();
    }
    catch (err) {
