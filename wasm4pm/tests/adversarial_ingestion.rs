...
use wasm4pm_compat::import::xes::{XESImportOptions, XESParsingTraceStream};
...
mod tests {
    ...
    fn test_adversarial_ocel_density_bounds() {
        ...
        use wasm4pm_compat::ocel::{OCELObject, OCELRelationship, OCEL};
    ...
    fn test_adversarial_poisoned_knowledge_base() {
        use wasm4pm_compat::import::persistence::IngestionKnowledgeBase;
        use wasm4pm_compat::import::timestamp_utils::parse_timestamp;
    ...
    fn test_adversarial_malformed_ocel_mapping() {
        use wasm4pm::oc_orchestrator::OntologyDiscoveryAgent;
        use wasm4pm_compat::ocel::{OCELObject, OCEL};
