...
import { AlgorithmRegistry, getRegistry, } from '../src/registry';
describe('AlgorithmRegistry', () => {
    ...
    describe('Algorithm Metadata', () => {
        ...
        it('log-discovery algorithms should have activity_key parameter', () => {
            ...
            for (const algo of algorithms) {
                if (!logProcessingIds.includes(algo.id))
                    continue;
    ...
    describe('Error Handling', () => {
        ...
        it('should return empty array for unknown profile', () => {
            const result = registry.getForProfile('unknown');
            expect(result).toEqual([]);
        });
        it('should return undefined suggestion for unknown profile', () => {
            const result = registry.suggestForProfile('unknown', 1000);
            expect(result).toBeUndefined();
        });
    });
    describe('Parameters', () => {
