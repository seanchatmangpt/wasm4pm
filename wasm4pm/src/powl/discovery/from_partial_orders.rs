...
mod tests {
    ...
    fn test_partial_order_fallback() {
        ...
        attr_a.insert("concept:name".to_string(), crate::models::AttributeValue::String("A".to_string()));

        let mut attr_b = Attributes::new();
        attr_b.insert("concept:name".to_string(), crate::models::AttributeValue::String("B".to_string()));
        ...
        let log = EventLog {
            ...
            traces: vec![crate::models::Trace {
                attributes: Attributes::new(),
                events: vec![
                    Event { attributes: attr_a.clone() },
                    Event { attributes: attr_b.clone() },
                ],
            }],
        };
