 ...
 */
export declare enum OCELAttributeType {
    String = "string",
    Int = "int",
    Float = "float",
    Boolean = "boolean",
 ...
 */
export type OCELAttributeValue = string | number | boolean | string;
/**
 * OCEL Event
 */
 ...
 */
export declare enum OCDeclareReductionMode {
    Union = "union",
 ...
 */
export declare enum DottedChartXAxis {
    CaseId = "case_id",
    EventSequence = "event_sequence",
    EventTimestamp = "timestamp",
    CustomAttribute = "custom_attribute"
}
export declare enum DottedChartYAxis {
    CaseId = "case_id",
    Duration = "duration",
    CustomAttribute = "custom_attribute"
}
export declare enum DottedChartColorAxis {
    Activity = "activity",
    Resource = "resource",
    CustomAttribute = "custom_attribute"
}
...
export declare enum EventLogIOErrorType {
    IOError = "io_error",
...
export declare enum OCELIOErrorType {
    IOError = "io_error",
    ParseError = "parse_error",
    SerializationError = "serialization_error",
...
export interface ProcessMiningAPI {
    discovery: {
         ...
         */
        discoverOCDFG(ocel: OCEL, options?: DFGOptions): Promise<ObjectCentricDirectlyFollowsGraph | Error>;
        /**
         ...
         */
        discoverOCDECLARE(ocel: OCEL, options?: OCDeclareDiscoveryOptions): Promise<OCDeclareModel | Error>;
        /**
         * Discover optimal Petri Net using ILP constraint-based optimization
         */
        discoverILPPetriNet(log: EventLog, options?: {
            activityKey?: string;
        }): Promise<PetriNet | Error>;
        /**
         * Discover DFG using weighted fitness-simplicity optimization
         */
        discoverOptimizedDFG(log: EventLog, options?: {
            activityKey?: string;
         ...
         */
        discoverGeneticAlgorithm(log: EventLog, options?: {
            activityKey?: string;
         ...
         */
        discoverPSOAlgorithm(log: EventLog, options?: {
            activityKey?: string;
            swarmSize?: number;
            iterations?: number;
        }): Promise<DirectlyFollowsGraph | Error>;
    ...
    analysis: {
         ...
         */
        getEventTimestamps(log: EventLog, bucketSize?: number): Promise<EventTimestampHistogram | Error>;
        /**
         * Get object attribute changes
         */
        getObjectAttributeChanges(ocel: OCEL, objectId?: string): Promise<ObjectAttributeChanges[] | Error>;
    };
    conformance: {
        /**
    ...
    io: {
         ...
         * Save an EventLog
         */
        saveEventLog(log: EventLog, path: string, options?: EventLogExportOptions): Promise<void | Error>;
        /**
         * Load OCEL
         */
