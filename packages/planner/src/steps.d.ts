 ...
 * @internal
 */
export declare function createAlgorithmStep(algorithmName: string, stepType: PlanStepType, parameters?: Record<string, unknown>, required?: boolean, dependsOn?: string[], parallelizable?: boolean): PlanStep;
/**
 ...
 * @internal
 */
export declare function createAnalysisStep(analysisName: string, stepType: PlanStepType, parameters?: Record<string, unknown>, dependsOn?: string[], parallelizable?: boolean): PlanStep;
/**
