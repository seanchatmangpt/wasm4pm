<!-- wasm4pm-doc-status: active; reviewed: 2026-08-02; original: .claude/worktrees/wf_99470ccd-c7b-1/docs_quarantine/ARCHIVE/PUBLISH_CHECKLIST_v26.4.23.md; source-sha256: 0b4eb17ae6995ff283faaf8007700ddcfdb153c0b2f01e511ad544fe88e33dd9; reason: tooling or agent control surface -->

# npm Publishing Checklist — v26.4.23

**Release Date**: 2026-04-16  
**Version**: 26.4.23 (April 16, 2026)  
...
### ✅ Version Alignment
- [x] Root `package.json`: 26.4.23
- [x] `wasm4pm/package.json`: 26.4.23
- [x] All 10 `@wasm4pm/*` packages: 26.4.23
...
### ✅ CHANGELOG.md
- [x] Version `[26.4.23] - 2026-04-16 — Vision 2030` complete
...
### ✅ Documentation
- [x] NPM_PUBLISH_SUMMARY_v26.4.23.md created
- [x] PUBLISH_CHECKLIST_v26.4.23.md created (this file)
...
npm view @wasm4pm/cli@26.4.23
npm view wasm4pm@26.4.23
npm view @wasm4pm/contracts@26.4.23
```
...
# Check package sizes
npm view @wasm4pm/cli@26.4.23 dist.unpackedSize
npm view wasm4pm@26.4.23 dist.unpackedSize
```
...
```bash
cd /Users/sac/chatmangpt/wasm4pm
git tag -a v26.4.23 -m "Release v26.4.23 - Vision 2030: Autonomic Loop"
...
3. Tag version: `v26.4.23`
4. Title: `Vision 2030 — v26.4.23`
5. Description: Copy from CHANGELOG.md `[26.4.23]` section
...
npm unpublish @wasm4pm/cli@26.4.23 --force
```
...
- [ ] `npm view @wasm4pm/cli@26.4.23` returns version 26.4.23
- [ ] `npm view wasm4pm@26.4.23` returns version 26.4.23
- [ ] All 10 `@wasm4pm/*` packages appear on npm
- [ ] `npm install @wasm4pm/cli@26.4.23` succeeds (global install)
- [ ] `wpm --version` outputs `26.4.23`
- [ ] `wpm doctor` exits 0
- [ ] GitHub release v26.4.23 created with CHANGELOG content
...
| Item | Status |
|------|--------|
| **All versions aligned to 26.4.23** | ✅ |
