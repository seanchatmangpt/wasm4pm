...
fn situation_calculus_input() -> BreedInput {
    BreedInput {
        intent: "project".into(),
        candidates: vec![],
        facts: vec![],
...
fn circumscription_input() -> BreedInput {
    BreedInput {
        intent: "entail".into(),
        candidates: vec![],
        facts: vec![
...
#[test]
fn determinism_situation_calculus() {
    assert_deterministic("situation_calculus", &situation_calculus_input());
}

#[test]
fn determinism_circumscription() {
    assert_deterministic("circumscription", &circumscription_input());
}

// ---------------------------------------------------------------------------
// Count assertion: exactly 19 breed determinism tests exist in this suite
// ---------------------------------------------------------------------------

#[test]
fn exactly_19_breed_pairs_covered() {
    let covered = [
        "eliza",
        "cbr",
        "dendral",
    ...
    assert_eq!(covered.len(), 19, "must cover exactly 19 breeds");
}
