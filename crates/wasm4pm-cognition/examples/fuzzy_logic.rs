...
fn main() {
    let input = BreedInput {
        ...
        facts: vec![
            ...
            Fact {
                key: "fuzzy:temp:cold".to_string(),
                value: "tri:0,10,20".to_string(),
            },
            Fact {
                key: "fuzzy:temp:comfortable".to_string(),
                value: "tri:15,22,28".to_string(),
            },
            Fact {
                key: "fuzzy:temp:hot".to_string(),
                value: "tri:24,35,45".to_string(),
            },
            // Membership functions for fan speed output variable
            Fact {
                key: "fuzzy:speed:off".to_string(),
                value: "tri:0,0,25".to_string(),
            },
            Fact {
                key: "fuzzy:speed:low".to_string(),
                value: "tri:10,30,50".to_string(),
            },
            Fact {
                key: "fuzzy:speed:high".to_string(),
                value: "tri:40,75,100".to_string(),
            },
