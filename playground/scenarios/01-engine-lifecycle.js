...
import { canTransition, VALID_TRANSITIONS, ALL_STATES, STATE_METADATA, isTerminalState, isOperationalState, isProcessingState, } from '@wasm4pm/engine';
...
describe('engine lifecycle: MockEngine state machine', () => {
    ...
    it('plan() returns an ExecutionPlan', async () => {
        ...
        console.info('[lifecycle] plan steps:', plan.steps.map((s) => s.type));
    });
...
//# sourceMappingURL=01-engine-lifecycle.js.map