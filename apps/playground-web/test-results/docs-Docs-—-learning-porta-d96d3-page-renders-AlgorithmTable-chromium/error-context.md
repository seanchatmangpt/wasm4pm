...
- Name: docs.spec.ts >> Docs — learning portal >> reference/algorithms page renders AlgorithmTable
- Location: tests/e2e/docs.spec.ts:28:3
...
Locator: locator('.algorithm-table').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.algorithm-table').first()
