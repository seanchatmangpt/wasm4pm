...
\label{chap:oracle}
\label{chap:oracle-hierarchy}
\label{chap:oracle-theorem}
...
The $\PROLOG$ breed implements SLD resolution over flat (non-recursive) terms, where the occurs-check is trivially satisfied by construction (the flat-term fragment precludes circular unification).  The
