    ...
    describe('basic construction', () => {
        ...
        it('should generate UUID if not provided', () => {
            const receipt = builder
                ...
                .setModel({})
                .build();
            expect(receipt.run_id).toMatch(/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i);
        });
...
//# sourceMappingURL=receipt-builder.test.js.map