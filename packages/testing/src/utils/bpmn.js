 ...
 */
export function parseBPMN(bpmnXml) {
 ...
 */
export function serializeBPMN(definition) {
    const lines = [];
 ...
 */
export function validateBPMN(bpmnXml) {
    const errors = [];
    const warnings = [];
    let definition;
    try {
 ...
 */
export function validateBPMNForProcessMining(bpmnXml) {
 ...
 */
export function createMinimalBPMN() {
 ...
 */
export function createParallelGatewayBPMN() {
    return `<?xml version="1.0" encoding="UTF-8"?>
<definitions id="Definition_1" targetNamespace="http://bpmn.io/schema/bpmn">
  <process id="Process_1" isExecutable="false">
    <startEvent id="StartEvent_1" />
 ...
 */
export function createExclusiveGatewayBPMN() {
    return `<?xml version="1.0" encoding="UTF-8"?>
<definitions id="Definition_1" targetNamespace="http://bpmn.io/schema/bpmn">
  <process id="Process_1" isExecutable="false">
    <startEvent id="StartEvent_1" />
 ...
 */
export function createInvalidBPMN() {
    return `<?xml version="1.0" encoding="UTF-8"?>
<definitions>
 ...
 */
export function roundTripBPMN(bpmnXml) {
    try {
 ...
 */
export function formatBPMNValidationResult(result) {
    const lines = [];
 ...
 */
export function countBPMNElementsByType(bpmnXml) {
 ...
 */
export function extractActivityNames(bpmnXml) {
    const names = [];
    try {
        const definition = parseBPMN(bpmnXml);
        for (const process of definition.processes) {
