...
import { BootstrapSpans, PlanningSpans, RunningSpans, WatchingSpans, } from '../src/spans.js';
import { createRootContext } from '../src/context.js';
describe('OTEL enabled (spans captured)', () => {
    ...
    const otelConfig = {
        ...
        required: false,
        batch_size: 50,
        timeout_ms: 60000, // long interval so auto-flush doesn't fire during tests
    };
    let fetchMock;
    beforeEach(() => {
...
//# sourceMappingURL=enabled.test.js.map