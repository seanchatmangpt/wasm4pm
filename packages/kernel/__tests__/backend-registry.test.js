...
describe('DefaultBackendRegistry', () => {
    ...
    describe('register and unregister', () => {
        ...
        it('should throw if backend missing id', () => {
            ...
            expect(() => registry.register(badBackend)).toThrow();
        });
        ...
        it('should timeout after 500ms', async () => {
            ...
            const slowBackend = {
                ...
                capabilities: () => ({
                    ...
                    supportedAlgorithmIds: ['dfg'],
                    maxConcurrentInvocations: 1,
                }),
                discover: async () => ({ status: 'failed', payload: null }),
                conformance: async () => ({ status: 'failed', payload: null }),
                analyze: async () => ({ status: 'failed', payload: null }),
                healthCheck: async () => {
...
//# sourceMappingURL=backend-registry.test.js.map