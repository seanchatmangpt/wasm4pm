#!/usr/bin/env bash
# chain.sh — legal-policy breed chain orchestrator
# Runs 6 cognition stages: frames_inheritance -> circumscription -> belief_merging -> problog -> sat_cdcl -> tableaux
set -euo pipefail
...
# ---------------------------------------------------------------------------
STAGES=(
  "0:0-frames_inheritance:frames_inheritance"
  "1:1-circumscription:circumscription"
  "2:2-belief_merging:belief_merging"
  "3:3-problog:problog"
  "4:4-sat_cdcl:sat_cdcl"
  "5:5-tableaux:tableaux"
)
