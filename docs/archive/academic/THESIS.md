...
>
> This thesis documents wasm4pm v0.5.4 (13 algorithms, 8 analytics). It is **superseded by [THESIS-V2.md](../../THESIS-V2.md)**, which covers v26.4.8 and later releases including:
>
...
> - 5 deployment profiles (browser/edge/fog/iot/cloud) with conditional compilation
> - 9-package TypeScript monorepo with pictl CLI
> - npm publication, MCP server, drift monitoring
>
> **Read [THESIS-V2.md](../../THESIS-V2.md) for the current state of the project.**
